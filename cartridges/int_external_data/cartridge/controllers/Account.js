        ...
        if (registrationForm.valid) {
            ...
            this.on("route:BeforeComplete", function (req, res) {
                ...
                if (registrationForm.validForm) {
                    ...
                    const data = configureServiceRequest.call("POST", "/users.json", body); // create user in firebase
...
server.append(
    ...
    function (req, res, next) {
        ...
        if (profileForm.valid) {
            ...
            const data = configureServiceRequest.call(
                "PUT",
...
server.append(
    ...
    function (req, res, next) {
        ...
        if (profileForm.valid) {
            ...
            if (userData) {
                passwordsMatch = userData.password === profileForm.login.currentpassword.value;

                if (passwordsMatch) {
                    userData.password = newPasswords.newpassword.value;

                    const success = configureServiceRequest.call("PUT",
                        `/users/${customerNo}.json`,
                        userData
                    );
                }
